...
export const EXERCISES: Exercise[] = [
  ...
  },
  {
    ...
    difficulty: 'schwer',
    description:
      'Gegeben X = {a, b}. Konstruiere einen DFA für L = { w ∈ X* | w = (ab)^n(aabb)^m mit n, m ∈ ℕ }.',
    hint: '',
    testCases: [
  ...
  },
  {
    ...
    testCases: [
      ...
      { input: 'bcc', expectedAccepted: true },
  ...
  },
  {
    ...
    pdaConfig: { startStackSymbol: '$' },
    testCases: [
      { input: 'aabccd', expectedAccepted: true },
